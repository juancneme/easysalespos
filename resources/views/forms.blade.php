      ...
      <div class="container">
         <div class="row">
            <div class="col-md-12 col-lg-12 col-xl-12 text">
               ...
               <div class="description">
                  <p>
                     <strong>Te pediremos algunos datos básicos para crear tu usuario y en breve puedes comenzar a
                        utilizar la plataforma.</strong>
                  </p>
               </div>
            </div>
         </div>
         <div class="row">
            <div
               ...
               <form action="{{route('save')}}" method="POST" class="f1">
                  ...
                  <fieldset>
                     ...
                     <div class="row">
                        <div class="input-group mb-5 col-lg-4 col-sm-4 col-md-4">
                           ...
                           <select class="custom-select" name="identificacion1" id="f1-typeDoc" required="required">
                  ...
                  <fieldset>
                     ...
                     <div class="row">
                        <div class="form-label-group col-lg-12 col-sm-12 col-md-12">
                           <input type="text" class="f1-addressStore form-control" name="direccion" id="f1-addressStore"
                  ...
                  <fieldset>
                     ...
                     <h3>Eso es todo :)</h3>
                     <h4>
                        En breves momentos te estará llegando el correo con tu usuario y contraseña para que ingreses a
                        la plataforma.
                     </h4>
                     <div class="f1-buttons">
                        <button type="button" class="btn btn-previous">Anterior</button>
