...
@section('content')
    ...
    <div class="panel-body form-add" style="margin-top: 110px;">
        ...
        <form action="/{{ $group . '/' . $page }}" method="POST" class="form-horizontal" style="padding-right: 15px;padding-left: 15px">
            <div style="padding-top:0px; margin-top:5px" class="panel-heading">{{ __('Inventory') }}</div>
    ...
    <div class="panel panel-default" style="margin-top: 110px;">
        <div style="padding-top:0px; margin-top:5px" class="panel-heading">{{ __('Inventory Control') }}
