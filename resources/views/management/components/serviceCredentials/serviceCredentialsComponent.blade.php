...
@endif
<div class="form-group row requerido-multimarca" style="display: none;">
    <label for="name" class="col-sm-3 col-form-label">{{ __('Companies') }}*</label>
    <div class="col-sm-6">
        <select name="companies_id" id="companies_id" class="form-control requerido-multimarca "
...
<div class="form-group row requerido-multimarca" style="display: none;">
    ...
    <div class="col-sm-6">
        <input type="text" name="user_name" id="user_name" class="form-control requerido-multimarca "
               <?= !empty($perEdit) && $perEdit == 'disabled' ? 'disabled' : '' ?> required
               value="{{ !empty($itemEdit) ? $itemEdit->user_name : '' }}"/>
    </div>
</div>
<div class="form-group row requerido-multimarca" style="display: none;">
    <label for="name" class="col-sm-3 col-form-label">{{ __('Password') }}*</label>
    <div class="col-sm-6">
        <input type="password" name="password" id="password"class="form-control requerido-multimarca "
               <?= !empty($perEdit) && $perEdit == 'disabled' ? 'disabled' : '' ?> required
...
<div class="form-group row requerido-multimarca" style="display: none;">
    ...
    <div class="col-sm-6">
        <input type="text" name="secret_key" id="secret_key" class="form-control requerido-multimarca "
               <?= !empty($perEdit) && $perEdit == 'disabled' ? 'disabled' : '' ?> required
...
<div class="form-group row requerido-multimarca" style="display: none;">
    ...
    <div class="col-sm-6">
        <input type="text" name="end_point" id="end_point" class="form-control requerido-multimarca "
               <?= !empty($perEdit) && $perEdit == 'disabled' ? 'disabled' : '' ?> required
...
<div class="form-group row requerido-multimarca" style="display: none;">
    ...
    <div class="col-sm-6">
        <input type="text" name="type_url" id="type_url" class="form-control requerido-multimarca "
...
<div class="form-group row requerido-multimarca" style="display: none;">
    ...
    <div class="col-sm-6">
        <select name="status" id="status" class="form-control requerido-multimarca "
                <?= !empty($perEdit) && $perEdit == 'disabled' ? 'disabled' : '' ?> required>
            <option
