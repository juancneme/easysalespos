					...
					<table>
						<tr>
							<td>
								...
								<!-- Callout Panel -->
								<p class="callout">
                                    Puedes crear tu cuenta en el siguiente enlace:<br />
                                    
									<a href="http://localhost/newclient?contract_id={{$contract_id}}" target="_blank"> Ingresa http://localhost/newclient</a>
								</p><!-- /Callout Panel -->
