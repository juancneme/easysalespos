        ...
        <td class="header container">
            ...
            <div class="content">
                <table bgcolor="#4980B5">
                    <tr>
                        <td><img src="http://des.salespoint/support/pictures/config/logos/logo000003.png" /></td>
                    </tr>
                </table>
            </div>
        </td>
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <p class="lead">Gracias por crear una cuenta de usuario en PDVI / Punto de Venta
                                Inteligente para tenderos y establecimientos comerciales.</p>

                            <!-- Callout Panel -->
                            <p class="callout">
                                Puedes acceder siguiendo los enlaces:<br />

                                Administración:<a href="{{$url . '/auth/login?par=' . $keyfisica}}" target="_blank">{{$url . '/auth/login?par=' . $keyfisica}}</a>

                                <br>

                                Clientes:<a href="{{$url . '/auth/login?par=' . $keyvirtual}}" target="_blank">{{$url . '/auth/login?par=' . $keyvirtual}}</a>
