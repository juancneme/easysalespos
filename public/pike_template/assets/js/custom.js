...
jQuery(document).ready(function ($) {
    ...
    $('<div class="input-number-nav"><div class="input-number-button quantity-up"></div><div class="input-number-button quantity-down"></div></div>').insertAfter('.input-number input');
